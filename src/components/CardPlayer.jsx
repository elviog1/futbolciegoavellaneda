...
export default function CardPlayer({player}) {
    ...
    const printCards = (item,i)=>{
        return (
            <div data-aos="fade-right" key={i} className={`rounded-xl flex justify-center flex-col max-w-sm my-3 shadow-xl hover:shadow-white duration-500 ${item.sex === "Mujer" ? "hover:shadow-pink-400" : "hover:shadow-blue-500"}`}>
